...
- Remove the mod and your items are safe — vanilla just shows the first 27 slots again, reinstall to see all 54
...
1. Download the `.jar` from [Modrinth](https://modrinth.com/mod/double-ender-chest) or [CurseForge](https://curseforge.com/minecraft/mc-mods/double-ender-chest)
